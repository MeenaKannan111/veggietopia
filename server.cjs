...
const recommendationRoutes = require('./backend/routes/recommendationRoutes.js').default;
const consumerRoutes = require('./backend/routes/consumerRoutes.js');
...
// Test route to verify POST /api/orders reachability
app.post('/api/orders', (req, res) => {
    console.log('Test POST /api/orders route reached');
    res.json({ message: 'Test order route reached' });
});
